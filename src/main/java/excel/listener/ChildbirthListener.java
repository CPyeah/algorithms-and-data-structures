 ...
 */
@Slf4j
public class ChildbirthListener extends
		AnalysisEventListener<Childbirth> {
	...
	@Override
	public void invoke(Childbirth data, AnalysisContext context) {
//		System.out.println("解析到一条数据:"+ data.toString());
		JSONObject jsonObject = (JSONObject) JSON.toJSON(data);
		String jsonString = jsonObject.toJSONString();
		jsonString = jsonString.replaceAll("%", "");

		data = JSONObject.parseObject(jsonString, Childbirth.class);
