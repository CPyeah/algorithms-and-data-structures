...
public class CommonUtils {
	...
	public static void main(String... strings) {
		...
		CommonUtils.printListList(convertLeetCode2DStringArrayInputIntoJavaArray(
				"[\"A\",\"B\"],[\"C\"],[\"B\",\"C\"],[\"D\"]"));
		CommonUtils.print(convertLeetCode1DStringArrayInputIntoJavaArray(
				"[\"abcsi\",\"abyzjgj\",\"advz\",\"ag\",\"agkgdkob\",\"agpr\",\"ail\"]"));
		CommonUtils.print2DIntArray(convertLeetCodeIrregularLengths2DArrayInputIntoJavaArray(
